...
- See tv_frontend/.env.example for supported environment variables (PORT, HOST) and how to use them instead of CLI flags. You may copy it to .env (cp tv_frontend/.env.example tv_frontend/.env) and adjust as needed.
